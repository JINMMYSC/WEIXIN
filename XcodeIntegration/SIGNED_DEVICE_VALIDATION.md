...
Use the supplied Apple Developer signing set:

- Team ID: `X5G6AN3DYX`
- Host App: `app.lgm.7517`
- Keyboard, Share, Widget, and Voice / Live Activity: `app.lgm.7517.123`
- Shared App Group: `group.7518554`

The extension bundle identifier is intentionally shared because the supplied extension provisioning profile authorizes only `app.lgm.7517.123`.
